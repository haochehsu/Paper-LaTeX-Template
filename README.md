...
Based on the NIPS styling, it makes this thesis template esthetic and convenient for reading. This template defines the styles and format in the `main.tex` preambles and collects all the imported packages in the `package.sty` making the source more transparent and easier to customize.
...
🎉 The compiled thesis PDF can be viewed [here](https://www.haochehsu.com/other/Thesis_LaTeX_Template.pdf).
...
For online editing, [download](https://github.com/howardhsumail/Thesis-LaTeX-Template/archive/refs/heads/main.zip) the template, upload all the files and folders to [Overleaf](https://www.overleaf.com/), and compile the `main.tex` as demonstrated [here](https://www.overleaf.com/read/tyrxpyssfgpp).
